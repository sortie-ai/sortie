...
- **Shared adapter helpers go in a dedicated `internal/` package, never duplicated per adapter and never in `internal/domain/`.** Cross-adapter helpers: `internal/httpkit`, `internal/issuekit`, `internal/trackermetrics`, `internal/typeutil`, `internal/registry`. Forge decision logic shared across `internal/scm/*`: `internal/scm/scmcore`. Test conformance assertions: `internal/adaptertest`.
