...
One navigational fact bears on the answer. The abbreviation of this protocol's name is already taken twice in this project's vocabulary, once by an unrelated industry protocol named in the project's own documentation and once by the project's file-based agent-to-orchestrator signalling. The abbreviation is therefore unusable here, and this record says "the protocol" after the name is introduced.
